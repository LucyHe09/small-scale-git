...
// A program to work with small-scale-git Manages the state of repositories and allows for all
// operations defined in small-scale-git.
public class Client {
        ...
        while (!op.equalsIgnoreCase("quit")) {
            ...
            if (op.equalsIgnoreCase("create")) {
                if (currRepo != null) {
                    ...
                    Repository newRepo = new Repository(name); //creation
    ...
    // Prints out an introduction to the small-scale-git test client.
    public static void intro() {
        System.out.println("Welcome to the test client!");
        System.out.println("Use this program to test the small-scale-git repository.");
        System.out.println();
    }
}
